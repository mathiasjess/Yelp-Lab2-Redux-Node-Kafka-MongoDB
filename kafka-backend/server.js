...
const customerprofiledetails = require('./services/customer/customerProfileDetails')
const updatecustomerprofile = require('./services/customer/updateCustomerProfile')
const searchrestaurant = require('./services/customer/searchRestaurant')
const writereview = require('./services/customer/writeReview')
const getcustomerreviews = require('./services/customer/getCustomerReviews')
const fetchEvents = require('./services/customer/fetchEvents')
const registerforevents = require('./services/customer/registerForEvents')
const fetchcustomerevents = require('./services/customer/fetchCustomerEvents')
const allusers = require('./services/customer/allUsers')
const addfollowers = require('./services/customer/addFollowers')
const following = require('./services/customer/Following')
...
// handleTopicRequest("customerprofiledetails",customerprofiledetails)
// handleTopicRequest("updatecustomerprofile",updatecustomerprofile)
// handleTopicRequest("searchrestaurant",searchrestaurant)
// handleTopicRequest("writereview",writereview)
// handleTopicRequest("getcustomerreviews", getcustomerreviews)
// handleTopicRequest("fetchEvents",fetchEvents)
// handleTopicRequest("registerforevents",registerforevents)
// handleTopicRequest("fetchcustomerevents",fetchcustomerevents)
// handleTopicRequest("allusers",allusers)
// handleTopicRequest("addfollowers",addfollowers)
// handleTopicRequest("following",following)